...
public class SpearAttackBehavior : MeleeAttackBehavior
{
    [Header("VFX")]
    [SerializeField] private GameObject slashHitboxPrefab;

    [Header("Hit Box")]
    [SerializeField] private Vector2 boxSize = new Vector2(1.4f, 0.45f);
    ...
    public override void OnAttackHit()
    {
        ...
        {
            Collider2D[] hits = Physics2D.OverlapBoxAll(currentTarget.transform.position, boxSize, angle, targetLayer);
            ApplyDamage(hits);
        }
    }
